<nav class="navbar navbar-expand-md shadow-sm">
    <div class="container">
       <a href="./index.html" class="navbar-brand fw-bold text-light text-uppercase">Mini Bazar</a>
       <!-- <img src="" alt=""> -->
       <div class="d-flex">
       ...
       <div class="offcanvas bg-secondary offcanvas-end" data-bs-scroll="true" tabindex="-1" id="openSidebar"
          ...
          <div class="offcanvas-body">
             <ul class="navbar-nav ms-auto">
                <li class="nav-item mx-4 h6"><a href="{{ route('home.index') }}" class="nav-link px-2 active">Services</a></li>
 ...
 <div class="offcanvas offcanvas-end px-3" data-bs-scroll="true" tabindex="-1" id="desktopCartOffcanvas"
